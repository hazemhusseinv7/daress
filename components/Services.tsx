          ...
          {services.map((service, i) => (
            ...
            >
              <div className="flex flex-col gap-2 sm:gap-5">
                ...
                <span>
                  <h3 className="hs-tab-active:text-main-color-1 block font-semibold text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">
                    {service.title}
                  </h3>
                  <p className="hidden lg:block mt-2 text-gray-800 dark:text-neutral-200 font-light text-sm">
                    {service.description}
                  </p>
                </span>
              </div>
